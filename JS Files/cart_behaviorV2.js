...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function extractProductData() {
        ...
        cartItems.forEach((item) => {
            ...
            const quantityInput = item.querySelector('input[type="hidden"][name^="cart"][name$="[qty]"]');
            const currentQuantity = quantityInput ? quantityInput.value.trim() : "N/A";
